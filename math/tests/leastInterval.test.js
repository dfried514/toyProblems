...
describe('leastInterval', () => {
  ...
  test('smaller idle', () => {
    expect(leastInterval(tasks5, n5)).toBe(e5);
  });
  test('long list', () => {
    expect(leastInterval(tasks6, n6)).toBe(e6);
  });
  test('another long list', () => {
    expect(leastInterval(tasks7, n7)).toBe(e7);
  });
});
